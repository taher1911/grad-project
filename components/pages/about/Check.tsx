...
const Check = (props: Props) => {
  return (
    ...
    >
      ...
      <div className="z-10">
        <h4 className="text-5xl font-bold">Check new AI based video content</h4>
        <p className="my-6 tracking-wider font-[500]">
        ...
        <Link
          href={``}
          className="mx-auto rounded-full block max-w-[250px] text-center capitalize font-bold tracking-wider text-[1.15rem] py-3 w-[100%] bg-gradient-to-r from-pink-500 to-violet-500  hover:scale-[1.03] transition-all duration-300"
